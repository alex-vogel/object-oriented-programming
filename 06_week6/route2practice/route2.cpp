...
/*
We can define methods (functions in a class) within the class, then implememnt them outside of the class. This is similar to how
you can have a function prototype outside of the main, call it in the main, and the function is implemented outside of the prototype and
the main.
*/
#include <iostream>
#include <ctime>
